...
class RvAdapterSolarVertical : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class SmallViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(adapterItemData: SolarResponseDTO) {
            ...
            itemView.findViewById<View>(R.id.view_scale_1of4).isVisible = true
            if (cType == "C" || cType == "M" || cType == "X") itemView.findViewById<View>(R.id.view_scale_2of4).isVisible = true
            if (cType == "M" || cType == "X") itemView.findViewById<View>(R.id.view_scale_2of4).isVisible = true
            if (cType == "X") itemView.findViewById<View>(R.id.view_scale_2of4).isVisible = true
        }
    }
